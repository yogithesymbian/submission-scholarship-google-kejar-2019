...
interface MovieRoomDao  {
    @Query("SELECT * FROM table_movies_room ORDER BY id ASC")
    fun getAllMovieRoom(): LiveData<List<MovieRoomModel>>
    ...
    @Query("DELETE FROM table_movies_room WHERE id = :id")
    suspend fun deleteSingleMovie(id: Long)
}